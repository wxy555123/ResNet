...
def data_augmentation(batch):
    ...
    batch = _random_crop(batch, [_height, _width], 4)
    return batch
...
def read_and_decode(filename):
    ...
    image = tf.reshape(image, [_height, _width, _depth])
...
# placeholder
x = tf.placeholder(tf.float32, [None, _height, _width, _depth])
